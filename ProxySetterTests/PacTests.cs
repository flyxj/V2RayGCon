...
namespace ProxySetterTests
{
    ...
    public class PacTests
    {
        ...
        {
            Assert.AreEqual(expect, Utils.IsIP(address));
        }
        ...
        {
            Assert.AreEqual(expect, Utils.IP2Long(address));
        }
        ...
        public void CompactRangeArrayListTest(string org, string expect)
        {
            long[] rangeParser(string rangeArray)
            {
                ...
                return new long[] {
                    (long)Utils.Str2Int(v[0]),
                    (long)Utils.Str2Int(v[1]),
                };
            }
            ...
            var result = Utils.CompactCidrList(ref o);
        ...
        {
            var proxyParams = Utils.GetQureryParamsFrom(
                url == null ? null : (
        ...
        {
            var c = Utils.Cidr2RangeArray(cidr);
            var a = Utils.Long2Ip(c[0]);
            var b = Utils.Long2Ip(c[1]);
