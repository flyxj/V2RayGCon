...
namespace V2RayGCon.Controller.OptionComponent
{
    class Import : OptionComponentController
    {
        ...
        List<Model.Data.ImportItem> CollectImportItems()
        {
            ...
            foreach (Model.UserControls.ImportUI item in this.flyPanel.Controls)
            {
                var v = item.GetValue();
        ...
        void InitPanel()
        {
            ...
            {
                this.flyPanel.Controls.Add(new Model.UserControls.ImportUI(item, UpdatePanelItemsIndex));
            }
        ...
        void BindEventBtnAddClick()
        {
            this.btnAdd.Click += (s, a) =>
            {
                this.flyPanel.Controls.Add(
                    new Model.UserControls.ImportUI(
        ...
        void BindEventFlyPanelDragDrop()
        {
            this.flyPanel.DragDrop += (s, a) =>
            {
                ...
                var data = a.Data.GetData(typeof(Model.UserControls.ImportUI))
                    as Model.UserControls.ImportUI;
