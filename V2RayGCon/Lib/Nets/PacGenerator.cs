...
namespace V2RayGCon.Lib.Nets
{
    public class PacGenerator
    {
        ...
        public static Tuple<string, string> GenPacFileResponse(
            ...
            string customPacFileContent)
        {
            ...
            {
                content = GenCustomPacFile(urlParam, pacSetting, customPacFileContent);
            }
            else
            {
                content = GenDefaultPacFile(urlParam, pacSetting);
            }
        ...
        static StringBuilder GenCustomPacFile(
            Model.Data.PacUrlParams urlParam,
            Model.Data.PacServerSettings pacSetting,
            string customPacFileContent)
        {
